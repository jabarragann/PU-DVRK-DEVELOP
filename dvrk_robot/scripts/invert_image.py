...
class image_converter:
  ...
  def __init__(self, cameraName):
    ...
    self.image_sub1 = rospy.Subscriber("/"+cameraName+"/left/image_raw",Image,self.callback1)
    self.image_sub2 = rospy.Subscriber("/"+cameraName+"/right/image_raw",Image,self.callback2)
